...
public class Task2Frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("TaskDuration");

        jLabel6.setText("TaskDescription");

        jLabel7.setText("DeveloperFirstName");

        jLabel8.setText("DeveloperLastName");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Task2Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Task2Frame().setVisible(true);
            }
        });
    }
